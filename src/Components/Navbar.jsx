    ...
    <nav className="bg-white border-[#3D3B3C] dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        <header className="flex justify-between items-center py-0.2px-1">
          <Link to="/" className="cursor-pointer flex items-center"> {/* Added flex and items-center classes */}
            <img src={mindset} className="h-12" alt="Mindset Academy" />
            <div className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white ml-2 font-serif"> {/* Added ml-2 for margin */}
              Mindset Academy
            </div>
          </Link>
        </header>
